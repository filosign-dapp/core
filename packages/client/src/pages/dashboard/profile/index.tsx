...
export default function ProfilePage() {
    ...
    const preferencesSection = useSectionState('preferences', form, mockProfileData)
    const profilePictureSection = useSectionState('profilePicture', form, mockProfileData)
