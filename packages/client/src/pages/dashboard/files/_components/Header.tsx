import { FunnelIcon, MagnifyingGlassIcon, RowsIcon, SquaresFourIcon } from "@phosphor-icons/react";
            ...
            <div className="flex items-center gap-2">
                <DropdownMenu>
                    ...
                    <DropdownMenuContent>
                        ...
                        <DropdownMenuItem onClick={() => onSort('lastModified')}>Last Modified</DropdownMenuItem>
                    </DropdownMenuContent>
                </DropdownMenu>
