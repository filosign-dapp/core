	...
	return (
		<section className="py-24 px-8 md:px-page max-w-7xl mx-auto">
			<div className="text-center mb-16 space-y-4">
				...
				>
					Your agreements working <br className="hidden md:block" />
					as hard as you do
				</motion.h2>
				<motion.p
					initial={{ opacity: 0, y: 20 }}
			...
			<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
				...
				>
					<Card className="h-full bg-card border-none shadow-none rounded-2xl overflow-hidden p-6 flex flex-col">
						<CardHeader className="pb-4">
							...
							<p className="text-muted-foreground text-sm leading-relaxed font-manrope font-light">
								Future-proof encryption using Dilithium crystals to protect your
								signatures against quantum threats.
							</p>
						</CardHeader>
				...
				>
					<Card className="h-full bg-card border-none shadow-none rounded-2xl overflow-hidden p-6 flex flex-col">
						<CardHeader className="pb-4">
							...
							<p className="text-muted-foreground text-sm leading-relaxed font-manrope font-light">
								Verify document authenticity instantly with our verifiable QR
								codes and on-chain proofs.
							</p>
						</CardHeader>
						<CardContent className="p-6 pt-0 flex-1 flex flex-col justify-end">
				...
				>
					<Card className="h-full bg-card border-none shadow-none rounded-2xl overflow-hidden p-6 flex flex-col">
						<CardHeader className="pb-4">
							...
							<p className="text-muted-foreground text-sm leading-relaxed font-manrope font-light">
								Keep your teams and data perfectly organized in separate
								workspaces.
							</p>
						</CardHeader>
						<CardContent className="p-6 pt-0 flex-1 flex flex-col justify-end">
				...
				>
					<Card className="h-full bg-card border-none shadow-none rounded-2xl overflow-hidden p-6">
