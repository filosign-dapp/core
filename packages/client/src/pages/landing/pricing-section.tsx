...
const plans = [
    {
        ...
        price: 0,
        priceSuffix: '',
        description: 'For personal projects and casual use. Get a feel for trustless signing.',
        features: [
    ...
    },
    {
        ...
        description: 'For professionals and freelancers who need unlimited, secure signing.',
        features: [
            'Everything in Hobby',
            'Unlimited documents',
            'Personal API Access',
    ...
    },
    {
        ...
        description: 'For businesses that need advanced features and integration capabilities.',
        features: [
            'Everything in Teams',
...
export default function PricingSection() {
    ...
    return (
        <section ref={sectionRef} className="lg:max-w-[80dvw] mx-auto flex flex-col gap-6 md:gap-8 py-8 md:py-12 p-8 md:p-page">
            <motion.div
