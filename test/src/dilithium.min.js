				...
				n =
					...
					(e) => {
						...
						var be = {
							...
							Me = {
								ops_table: null,
								mount: (_e) => Me.createNode(null, "/", 16895, 0),
								createNode: (e, t, r, o) => {
								...
								node_ops: {
									...
									rename: (e, t, r) => {
										if (Ae.isDir(e.mode)) {
											...
											if (o)
												for (var _n in o.contents) throw new Ae.ErrnoError(55);
										}
									...
									rmdir: (e, t) => {
										...
										for (var _o in r.contents) throw new Ae.ErrnoError(55);
										delete e.contents[t], (e.timestamp = Date.now());
									},
									readdir: (e) => {
										var t = [".", ".."];
							...
							Ae = {
								...
								mount: (e, t, r) => {
									...
									return (
										...
										n
											? (Ae.root = d)
											: o && ((o.mounted = s), o.mount?.mounts.push(s)),
										d
									);
								},
								unmount: (e) => {
								...
								msync: (e, t, r, o, n) =>
									e?.stream_ops.msync ? e.stream_ops.msync(e, t, r, o, n) : 0,
								munmap: (_e) => 0,
								ioctl: (e, t, r) => {
								...
								createFile: (e, t, _r, o, n) => {
									var i = be.join2(
											"string" === typeof e ? e : Ae.getPath(e),
											t,
										),
										a = Ae.getMode(o, n);
								...
								createLazyFile: (e, t, r, o, n) => {
									...
									return (
										Object.keys(d.stream_ops).forEach((e) => {
											...
											l[e] = () => (
												Ae.forceLoadFile(d), t.apply(null, arguments)
											);
										}),
										(l.read = (e, t, r, o, n) => {
											Ae.forceLoadFile(d);
						...
						var xe,
							...
							Xe =
								...
								(i._emscripten_stack_init = () =>
									(Xe = i._emscripten_stack_init =
							...
							Qe =
								...
								(i._emscripten_stack_get_base = () =>
									(Qe = i._emscripten_stack_get_base =
										i.asm.emscripten_stack_get_base).apply(null, arguments))),
							Be = (i._emscripten_stack_get_end = () =>
								(Be = i._emscripten_stack_get_end =
						...
						if (
							...
							(i.ccall = k),
							(i.cwrap = (e, t, r, _o) => () => k(e, t, r, arguments)),
							(i.setValue = b),
							(i.getValue = v),
