...
export function useSelfReload() {
    ...
    const selfClient = wallet?.account.address === wallet1.account.address ? queryClient1 : queryClient2;
...
export function useOtherReload() {
    ...
    const otherClient = wallet?.account.address === wallet1.account.address ? queryClient2 : queryClient1;
        ...
        return (
            <div className="flex items-center justify-center bg-cyan-100">
                <div className="text-center">
                    <p className="text-xl font-semibold">Initializing Dilithium WASM...</p>
        ...
        <div className="flex divide-x-2 divide-black bg-cyan-50 min-h-screen">
            <main>
                <QueryClientProvider client={queryClient1}>
                    <FilosignProvider wallet={wallet1} apiBaseUrl="http://localhost:30011/api" wasm={{ dilithium }}>
                        <Test />
                    </FilosignProvider>
                </QueryClientProvider>
            </main>
            <main>
                <QueryClientProvider client={queryClient2}>
                    <FilosignProvider wallet={wallet2} apiBaseUrl="http://localhost:30011/api" wasm={{ dilithium }}>
                        <Test />
                    </FilosignProvider>
                </QueryClientProvider>
            </main>
